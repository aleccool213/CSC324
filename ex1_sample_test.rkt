...
(test (search-table '((1 2 3) (4 2) (3 3 4) (5 3 2 1)) 5)
      '((5 3 2 1)))
...
(test (search-table-2 '((1 2 3) (4 2) (3 3 4) (5 3 2 1)) 10 0)
      '())

(test (search-table-2 '((1 -1 3) (4 -2) (3 3 4) (5 3 2 1)) -1 1)
      '((1 -1 3)))
...
(test (max-sublist '(-4 -1 -2 -3))
      0)
(test (max-sublist '(-4 5 5 -3))
      10)
(test (max-sublist '(-4 5 -3))
      5)
(test (max-sublist '())
      0)

(test (find-max-starting 0 '(-1 10 -4 5 3 -100 6))
  13)
(test (find-max-starting 0 '(-4 -1 -2 -3))
  0)
