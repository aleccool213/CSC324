...
(test (cartesian-product '((1)) '((1)))
      '((1 1)))

(test (cartesian-product '() '((1 2) (1 4)))
      '())

(test (cartesian-product '((1 2)) '())
      '())

(test (cartesian-product '((1 2 3) (4 5) ()) '((1 1 1) (2 2) (1 3 4)))
      '((1 2 3 1 1 1) (1 2 3 2 2) (1 2 3 1 3 4) (4 5 1 1 1) (4 5 2 2) (4 5 1 3 4) (1 1 1) (2 2) (1 3 4)))
